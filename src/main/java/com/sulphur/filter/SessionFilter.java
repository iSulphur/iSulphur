...
public class SessionFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        // 不过滤的uri
        String[] notFilter = new String[] { "/admin/login.html", "/index.jsp", "/admin/admin.do","/admin/team.do","/admin/task.do","/admin/url.do","/teacher/draft.html","/teacher/dtaft-in.html","/teacher/rank.html","/teacher/review.html","/teacher/task.html","/teacher/view.html", "/teacher/report_manager.do", "/teacher/review_manager.do",
